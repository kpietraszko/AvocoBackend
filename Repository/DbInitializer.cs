	...
	public static class DbInitializer
	{
		public static void Seed(ApplicationDbContext context)
		{
			...
			if (!context.Events.Any())
			{
                ...
                context.Events.Add(new Event { GroupId = 1, EventName = "Defilada", EventDateTime = new DateTime(2018, 7, 17, 12, 30, 0), EventLocationLat = 53.677367, EventLocationLng = 20.684959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Pokaz broni", EventDateTime = new DateTime(2018, 8, 1, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.684959 });
            ...
            if (!context.Posts.Any()) //tudu
            {
                ...
                context.Posts.Add(new Post {GroupId = 1, UserId = 3, Content = "jsshshshshshs" });
                context.Posts.Add(new Post {GroupId = 1, UserId = 6, Content = "tesasdasdsadasdasdasd" });
                //wyswietla tylko pierwszy post
                context.SaveChanges();
            }
		}
	}
