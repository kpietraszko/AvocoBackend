	...
	public static class DbInitializer
	{
		public static void Seed(ApplicationDbContext context)
		{
			...
			if (!context.Events.Any())
			{
				...
				eventsToAdd.Add(new Event { Group = group, EventName = "Defilada", EventDateTime = new DateTime(2018, 7, 17, 12, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Pokaz broni", EventDateTime = new DateTime(2018, 8, 1, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Maraton filmów wojennych", EventDateTime = new DateTime(2018, 7, 11, 20, 0, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Maraton filmów wojennych 2", EventDateTime = new DateTime(2018, 7, 12, 20, 0, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Amatorski trening polowy", EventDateTime = new DateTime(2018, 6, 19, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Spotkanie z weteranami", EventDateTime = new DateTime(2018, 8, 20, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Strzelanie do kaczek", EventDateTime = new DateTime(2018, 7, 19, 7, 00, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Strzelanie do dzików", EventDateTime = new DateTime(2018, 9, 8, 7, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(event2);
				eventsToAdd.Add(new Event { Group = group, EventName = "Wspólne ostrzenie bagnetów", EventDateTime = new DateTime(2018, 8, 11, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				eventsToAdd.Add(new Event { Group = group, EventName = "Wywiad z członkiem SWAT", EventDateTime = new DateTime(2018, 8, 16, 10, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
				/*context.Events.Add(new Event { GroupId = 16, EventName = "Maraton filmowy", EventDateTime = new DateTime(2018, 6, 21, 22, 20, 0), EventLocationLat = 53.477367, EventLocationLng = 20.284959 });
				context.Events.Add(new Event { GroupId = 16, EventName = "Szkolenie z pythona", EventDateTime = new DateTime(2018, 7, 11, 11, 0, 0), EventLocationLat = 53.977367, EventLocationLng = 20.384959 });
				context.Events.Add(new Event { GroupId = 16, EventName = "Sesja zdjeciowa", EventDateTime = new DateTime(2018, 6, 1, 8, 0, 0), EventLocationLat = 53.577367, EventLocationLng = 20.584959 });
				context.Events.Add(new Event { GroupId = 16, EventName = "Bieg wokol jeziora", EventDateTime = new DateTime(2018, 7, 20, 14, 0, 0), EventLocationLat = 52.777367, EventLocationLng = 21.484959 });
				context.Events.Add(new Event { GroupId = 16, EventName = "Wspolne granie na stadionie", EventDateTime = new DateTime(2018, 7, 11, 20, 0, 0), EventLocationLat = 53.447367, EventLocationLng = 20.224959 });
				context.Events.Add(new Event { GroupId = 16, EventName = "Prelekcja o ziolach bagiennych", EventDateTime = new DateTime(2018, 6, 20, 13, 0, 0), EventLocationLat = 53.677367, EventLocationLng = 20.784959 });*/
				context.Events.AddRange(eventsToAdd);
				//if (!context.EventsJoinedUsers.Any())
				//{
			...
			if (!context.GroupsJoinedUsers.Any())
			{
				context.GroupsJoinedUsers.AddRange(
					 new GroupJoinedUser { UserId = 1, GroupId = 16 },
					 new GroupJoinedUser { UserId = 6, GroupId = 16 },
			...
			{
				var post1 = new Post { GroupId = 16, UserId = 3, Content = "Hej :) Ostatnio zainteresowałem się okresem II WŚ. Mogłby ktoś polecic mi jakieś materiały na ten temat? Moze jakieś ksiażki?" };
				...
				var post3 = new Post { GroupId = 16, UserId = 3, Content = "Wybiera sie ktos na defilade do Olsztyna? Mój przyjaciel w ostatniej chwili niestety zrezygnował i teraz nie mam z kim iść, a z kimś zawsze weselej. Chetni niech piszą w komentarzach, może zbierzemy jakaś grupe na wspólny wypad!" };
