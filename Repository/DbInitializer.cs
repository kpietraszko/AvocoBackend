	...
	public static class DbInitializer
	{
		public static void Seed(ApplicationDbContext context)
		{
			...
			if (!context.Events.Any())
			{
                ...
                context.Events.Add(new Event { GroupId = 1, EventName = "Maraton filmów wojennych", EventDateTime = new DateTime(2018, 7, 11, 20, 0, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Maraton filmów wojennych 2", EventDateTime = new DateTime(2018, 7, 12, 20, 0, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Amatorski trening polowy", EventDateTime = new DateTime(2018, 6, 19, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Spotkanie z weteranami", EventDateTime = new DateTime(2018, 8, 20, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Strzelanie do kaczek", EventDateTime = new DateTime(2018, 7, 19, 7, 00, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Strzelanie do dzików", EventDateTime = new DateTime(2018, 9, 8, 7, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Wyscigi czołgów", EventDateTime = new DateTime(2018, 6, 11, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Wspólne ostrzenie bagnetów", EventDateTime = new DateTime(2018, 8, 11, 8, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
                context.Events.Add(new Event { GroupId = 1, EventName = "Wywiad z członkiem SWAT", EventDateTime = new DateTime(2018, 8, 16, 10, 30, 0), EventLocationLat = 53.777367, EventLocationLng = 20.484959 });
